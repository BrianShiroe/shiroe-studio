    ...
    <section id="contact" className="flex flex-col items-center justify-center py-20 relative z-10">
      <div className="max-w-[1200px] w-full px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
          ...
          <div className="rounded-[32px] border border-[rgba(255,255,255,0.08)] bg-white/5 p-6 md:p-8 shadow-[0_20px_80px_rgba(0,0,0,0.18)] backdrop-blur-sm relative overflow-hidden">
              ...
              {contactItems.map((item) => {
                ...
                return (
                  <a
                    ...
                    className="group rounded-2xl border border-[rgba(255,255,255,0.06)] bg-black/20 p-4 flex items-center justify-between gap-4 transition-all duration-300 hover:border-[rgb(112,66,248)]/60 hover:bg-white/10"
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-gray-200 text-[15px] font-light tracking-wide truncate mt-0.5 group-hover:text-white transition-colors duration-200">
                          {item.value}
                        </div>
                      </div>
                    </div>
